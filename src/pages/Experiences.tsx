...
import { Search, Clock, ChevronDown, ShieldCheck, Mail, Phone, ExternalLink, MapPin, Star } from 'lucide-react';
import { Link } from 'react-router-dom';
import { activities, categories, agents, Agent } from '@/data/experiences';
